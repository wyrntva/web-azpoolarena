      ...
      <div className="flex-1 max-w-[1360px] mx-auto px-4 sm:px-6 md:px-8 w-full relative z-10 -mt-12 sm:-mt-20 md:-mt-[126px] pb-16">
        <div className="w-full flex flex-col gap-[12px]">
          ...
          <div className="bg-white rounded-[16px] lg:rounded-3xl shadow-sm w-full relative pt-0 pb-8 pr-8 pl-4 md:pb-10 md:pr-10 md:pl-4 transition-all hover:shadow-[0_12px_30px_rgba(0,0,0,0.05)]">
            ...
            <div className="space-y-1">
              <a 
                ...
                className="flex items-center space-x-4 text-[#172339] py-0.5"
              >
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[18px] flex-shrink-0 text-[#172339]">
              ...
              <a 
                ...
                className="flex items-center space-x-4 text-[#172339] py-0.5"
              >
                <FaFacebook className="text-[18px] text-[#172339]" />
              ...
              <a 
                ...
                className="flex items-center space-x-4 text-[#172339] py-0.5"
              >
                <FaTiktok className="text-[18px] text-[#172339]" />
          ...
          <div className="bg-white rounded-[16px] lg:rounded-3xl shadow-sm w-full relative pt-0 pb-8 pr-8 pl-4 md:pb-10 md:pr-10 md:pl-4 transition-all hover:shadow-[0_12px_30px_rgba(0,0,0,0.05)]">
            ...
            {/* Clean list with icons, aligned left but centered group */}
            <div className="space-y-1">
              <div className="flex items-center space-x-4 text-[#172339] py-0.5">
                <IoCallOutline className="text-[18px] text-[#172339] flex-shrink-0" />
                <span className="font-medium text-[16px]">0364756638</span>
              </div>

              <div className="flex items-center space-x-4 text-[#172339] py-0.5">
                <IoMailOutline className="text-[18px] text-[#172339] flex-shrink-0" />
                <span className="font-medium text-[16px]">poolarena.vn@gmail.com</span>
              </div>

              <div className="flex items-start space-x-4 text-[#172339] py-0.5">
                <IoLocationOutline className="text-[18px] text-[#172339] flex-shrink-0 mt-0.5" />
