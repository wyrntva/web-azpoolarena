...
export default function TournamentNavbar({ activeTab = "info" }: Props) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white shadow-[0_-8px_30px_rgba(0,0,0,0.08)] rounded-t-[20px] sm:rounded-t-[24px] h-[52px] sm:h-[65px]">
      <div className="w-full h-full flex items-center justify-around px-2 sm:px-8 pb-0.5 sm:gap-3">
            ...
            >
              ...
              <g id="SVGRepo_iconCarrier">
                <path
                  ...
                  className={activeTab === "info" ? "fill-white" : "fill-[#37393E] group-hover:fill-[#172339]"}
                  fillRule="evenodd"
                />
                <path
          ...
          icon={
            ...
            >
              ...
              <path
                ...
                className={activeTab === "matches" ? "stroke-white" : "stroke-[#37393E] group-hover:stroke-[#172339]"}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              ...
              <g id="SVGRepo_iconCarrier">
                <g>
                  ...
                  <path
                    ...
                    className={activeTab === "live" ? "fill-white" : "fill-[#37393E] group-hover:fill-[#172339]"}
                  />
                  <path
            ...
            >
              <g clipPath="url(#clip0)">
                <path
                  ...
                  className={activeTab === "rankings" ? "fill-white" : "fill-[#37393E] group-hover:fill-[#172339]"}
                />
                <path
          ...
          icon={
            ...
            >
              <path
                ...
                className={activeTab === "fav" ? "stroke-white" : "stroke-[#37393E] group-hover:stroke-[#172339]"}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
