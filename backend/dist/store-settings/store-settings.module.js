...
const store_settings_controller_1 = require("./controllers/store-settings.controller");
...
exports.StoreSettingsModule = StoreSettingsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([entities_1.StoreSettingsEntity])],
