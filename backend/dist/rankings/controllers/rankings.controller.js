...
let RankingsController = class RankingsController {
    ...
    async getRankings(pageStr, limitStr, rankId, gender, sort) {
        const page = pageStr ? parseInt(pageStr, 10) : 1;
        const limit = limitStr ? parseInt(limitStr, 10) : 20;
        return this.service.getRankings(page, limit, rankId, gender, sort || '-points');
    }
};
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('filter[rank_id]')),
    __param(3, (0, common_1.Query)('filter[gender]')),
