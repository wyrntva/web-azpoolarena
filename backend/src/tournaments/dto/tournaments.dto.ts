...
export class CreateTournamentDto {
  ...
  @IsOptional() @IsString() match_creation_time?: string | null;
  @IsOptional() @IsString() match_creation_time_end?: string | null;
  ...
  @IsOptional() @IsString() draw_touch_11?: string | null;
...
export class UpdateMatchDto {
  ...
  @IsOptional() @IsDateString() match_time?: string;
  @IsOptional() @IsDateString() match_end_time?: string;
