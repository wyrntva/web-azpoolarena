...
export function convertFormDataToAPI(
    ...
    const apiData: Record<string, unknown> = {
        ...
        free_registration_fee: data.free_registration_fee,
        free_table_fee: data.free_table_fee,
        pre_payment: data.pre_payment,
        registration_fee: data.free_registration_fee ? 0 : (data.registration_fee ? parseFloat(data.registration_fee) : null),
