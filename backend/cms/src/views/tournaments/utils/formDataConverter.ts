...
export function convertFormDataToAPI(
    ...
    const apiData: Record<string, unknown> = {
        ...
        match_creation_time: data.match_creation_time?.trim() || null,
        match_creation_time_end: data.match_creation_time_end?.trim() || null,
        ...
        free_registration_fee: data.category === 'event' ? true : data.free_registration_fee,
        free_table_fee: data.category === 'event' ? false : data.free_table_fee,
        pre_payment: data.category === 'event' ? false : data.pre_payment,
        registration_fee: (data.category === 'event' || data.free_registration_fee) ? 0 : (data.registration_fee ? parseFloat(data.registration_fee) : null),
        ...
        draw_touch_11: data.draw_touch_11 || null,
    ...
    if (isUpdate) {
        const IMPORTANT_FIELDS = [
            'public_date', 'start_date', 'end_date', 'match_creation_time', 'match_creation_time_end', 'registration_start_date', 'registration_end_date',
