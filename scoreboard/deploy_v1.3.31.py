#!/usr/bin/env python3
"""
Deploy v1.3.31 — Fix scoreboard MQTT start state tracking (reporting correct active page/mode on start/reconnect)

Files deployed:
  - core/mqtt_service.py           : tracks current page/mode and reports it correctly
  - VERSION                        : 1.3.31

Usage: SB_PASS=admin python deploy_v1.3.31.py
"""
...
def main():
    version = file_contents.get("VERSION", "1.3.31")
    print("=" * 64)
    print(f"  AZ Scoreboard — Deploy v{version}")
    print("  Fix MQTT start state tracking")
