#!/usr/bin/env python3
"""
Deploy v1.3.26 — Ngăn đồng hồ chạy tự động, bắt buộc nhấn "Bắt đầu trận đấu"

Files deployed:
  - qml/components/TournamentJoinDialog.qml: Bỏ auto-close, thêm confirmText nút "Bắt đầu"
  - qml/pages/TournamentPage.qml: Chỉ bỏ qua check-in nếu có running timer (>0)
  - VERSION: 1.3.26

Usage: python deploy_v1.3.26.py
"""
...
PASSWORD = os.environ.get("SB_PASS", "admin")  # read from env or fallback to admin
...
def main():
    ...
    version = file_contents.get("VERSION", "1.3.26")
    print("=" * 64)
    print(f"  AZ Scoreboard - Deploy v{version}")
    print("  Ngăn đồng hồ chạy tự động, bắt buộc nhấn 'Bắt đầu trận đấu'")
