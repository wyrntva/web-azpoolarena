...
Item {
    ...
    Connections {
        ...
        function onPlayersUpdated(playersJson) {
            console.log("[RemoteControl] MultiScorePage received player updates")
    ...
    TopActionBar {
        ...
        // Handicap tile
        showHandicapTile: settingsDlg.handicapHalf
        handicapActive: settingsDlg.handicapFirstGame
        handicapTextYes: trLocal("handicap_yes")
        handicapTextNo:  trLocal("handicap_no")
    ...
    HandicapSettingsDialog {
        ...
        onSettingsChanged: topActions.resetHandicap(settingsDlg.handicapFirstGame)
    }
    ...
    AddPointsDialog {
        ...
        playerModel: players
        showHandicapTick: settingsDlg.handicapHalf
        ...
        onAppliedChanges: {
            if (!addPointsDlg.skipHandicapToggle) {
                topActions.toggleHandicap()
            }
        }
    }
