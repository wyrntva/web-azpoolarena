#!/usr/bin/env python3
"""
Deploy v1.3.21 — Bugfix: Fix QML TableFeePaymentDialog loading error (onCancelClicked -> onCancelled)

Các thay đổi:
  - qml/components/TableFeePaymentDialog.qml: Rename onCancelClicked to onCancelled
  - VERSION: 1.3.20 → 1.3.21

Chạy: python deploy_v1.3.21.py
"""
...
def main():
    version = file_contents.get("VERSION", "1.3.21")
    print(f"{'='*64}")
    print(f"  AZ Scoreboard - Deploy v{version}")
    print(f"  Bugfix: Fix QML TableFeePaymentDialog loading error")
