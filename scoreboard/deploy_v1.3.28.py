#!/usr/bin/env python3
"""
Deploy v1.3.28 — Fix live score: gửi điểm ngay khi vào trang, xóa khi rời trang

Files deployed:
  - core/live_score_service.py   : Thêm clearScore() slot — gọi DELETE khi rời trang
  - qml/pages/ScorePage.qml     : Component.onCompleted gửi điểm ban đầu + clearScore khi rời
  - qml/pages/MultiScorePage.qml: Tương tự ScorePage
  - VERSION                      : 1.3.28

Usage: SB_PASS=admin python deploy_v1.3.28.py
"""
...
def main():
    version = file_contents.get("VERSION", "1.3.28")
    print("=" * 64)
    print(f"  AZ Scoreboard — Deploy v{version}")
    print("  Fix live score: gửi điểm khi load + xóa khi rời trang")
