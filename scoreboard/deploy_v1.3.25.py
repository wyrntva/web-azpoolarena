#!/usr/bin/env python3
"""
Deploy v1.3.25 — Hiển thị Giờ vào, Giờ ra, Thời gian trong dialog thanh toán tiền bàn

Files deployed:
  - qml/components/TableFeePaymentDialog.qml: Thêm startTime, endTime, elapsedSec
  - qml/pages/TournamentPage.qml: Truyền thời gian vào dialog thanh toán
  - VERSION: 1.3.25

Usage: python deploy_v1.3.25.py
"""
...
PASSWORD = os.environ.get("SB_PASS", "")  # set via: $env:SB_PASS='...' (PowerShell) or export SB_PASS='...' (bash)
...
def main():
    if not PASSWORD:
        print("[ERROR] Chưa điền PASSWORD. Mở file và điền vào dòng: PASSWORD = \"...\"")
        sys.exit(1)

    version = file_contents.get("VERSION", "1.3.25")
    print("=" * 64)
    print(f"  AZ Scoreboard - Deploy v{version}")
    print("  Hiển thị Giờ vào / Giờ ra / Thời gian trong dialog thanh toán tiền bàn")
